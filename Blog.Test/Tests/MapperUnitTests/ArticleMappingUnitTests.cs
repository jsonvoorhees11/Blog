...
namespace Blog.Test{
    public class ArticleMappingUnitTests{
        ...
        //Arrange
            ...
            var userJsonString = @"{""id"":""f6eb594c-4c06-4dec-9412-133c2d32a549"",
            ...
            var articleMapper = new ArticleMapper(user: user);
        ...
        [Fact]
        public void MappingArticleToArticleDto_ResultShouldContainAuthorInformation_WhenValidAuthorId(){
            //Arrange
            var articleJsonString = @"{""id"":""9a574346-a3a5-4860-a3bd-54be358ba236"",
                        ""title"":""How .NET compiler work?"",
                        ""slug"":""how-net-compiler-work"",
        ...
        [Fact]
        public void MappingArticleToArticleDto_ResultShouldNotContainAuthor_WhenInvalidAuthorId(){
            //Arrange
            var articleJsonString = @"{""id"":""9a574346-a3a5-4860-a3bd-54be358ba236"",
                        ""title"":""How .NET compiler work?"",
                        ""slug"":""how-net-compiler-work"",
                        ...
                        ""createdDate"": ""1560182949"",
                        ""lastModifiedDate"":""1560182949"",
                        ""authorId"":""id-that-does-not-match""}";
